<x-layouts.base>
    ...
    <div class="w-screen h-screen flex items-center justify-center">
        <form class="flex flex-col space-y-4" method="post">
            ...
            <!-- Email address -->
            <x-input name="name" type="text" label="{{ __('Name') }}" icon="o-user" error-field="email" class="w-80" value="{{ old('name') }}" />
            ...
            <x-input name="password_confirmation" type="password" label="{{ __('Confirm Password') }}" icon="o-key" error-field="password_confirmation" class="w-80" />
